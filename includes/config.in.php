...
define("DB_NAME","test_compuloc".WEB_BUDGET);
//define("DB_NAME","nonmueang".WEB_BUDGET);
define("DB_USERNAME","root");
define("DB_PASSWORD","0147");	
