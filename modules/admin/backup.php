...
// --------------------------------------------------------------------------------
  ...
  define( 'PCLZIP_TEMPORARY_DIR', "".WEB_PATH."" );
...
$filezipname = 'backup/'.date('Y-m-d').'-data_backup.zip';
$files=substr($filezipname,7,26);

$new_zip= new PclZip($filezipname);
$file_list = $new_zip->create('./');
if ($file_list == 0) 
{
...
<body>
 ...
 <br> <br>
 <?
echo "<center><h4>แบ็คอัพข้อมูลเวปเรียบร้อยแล้วครับ ดาวน์โหลด:<a href=\"".WEB_URL."/backup/$files\" target=\"_blank\">&nbsp;&nbsp;$files</a></h4><br><br><font color=red><h4>หลังจากดาวน์โหลดแล้ว ควรลบไฟล์ $files ออกจากเซิฟเวอร์ทันทีครับ</font></h4>";
?>
