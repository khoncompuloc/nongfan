...
<script language="javascript">
	function selData(form)
	{
		...
		if (sd_logic==1) {
		var sh_shop = self.opener.document.getElementById("sd_name_"+frmMain.been_paid_hidden.value);
		sh_shop.value = frmMain.been_paid.value;
        window.close();		
        } else {
...
<table width="350" border="0" align="center">
  <tr>
    <td height="30" colspan="2" ><div align="center"><center>
		...
		<input name="been_paid_hidden" id="been_paid_hidden" type="hidden" value="<?php echo $line ;?>" />
		<input name="sd_logic_hidden" id="sd_logic_hidden" type="hidden" value="<?php echo $sd_logic ;?>" />
    </td>
  </tr>
  <tr><td height="25"></td><td></td></tr>
  <tr><td height="30" colspan="2" ><div align="center"><center>
  <input  type="button" onClick="clear_shop(this.form);" value="เครียข้อมูล<?php echo $data_value ;?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
  <input  type="button" onClick="close_shop();" value="ปิดหน้าต่างนี้">
  </center></div></td></tr>
</table>
</form>
<?php
