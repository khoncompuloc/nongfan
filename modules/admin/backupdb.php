...
echo "<center><h4>แบ็คอัพ databases เรียบร้อยแล้วครับ ดาวน์โหลด:<a href=\"".WEB_URL."/backup/$files\" target=\"_blank\">&nbsp;&nbsp;$files</a></h4><br><br><font color=red><h4>หลังจากดาวน์โหลดแล้ว ควรลบไฟล์ $files ออกจากเซิฟเวอร์ทันทีครับ</font></h4>";
?>
<h4><a href="index.php?folder=admin&file=filemanager&u=admin&copt=1&sortKey=0&pathext=backup/" target="_blank"><<  ถ้าต้องการไปยังที่อยู่ไฟล์สำหรับ backup กดที่นี่ครับ >></a></h4>
