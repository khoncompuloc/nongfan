...
$count = 18 ; //จำนวนแถว
	...
	$res['stock_details'] = $db->select_query("SELECT UNIX_TIMESTAMP(sd_date) AS st_date ,sd_name ,sd_ref ,sd_price ,sd_amount ,sd_amountcost ,sd_pricecost ,sd_note ,sd_logic ,shf_id FROM ".TB_STOCK_SECTION.$budget." WHERE sh_id='".$sh_id."' ORDER BY sd_id ");
...
<span style='font-size:18.0pt;font-family:"TH SarabunPSK"'>
...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes'>
  <td width=950 valign=top style='width:753.45pt;padding:0cm 5.4pt 0cm 5.4pt'>
 ...
 <tr style='mso-yfti-irow:1;mso-yfti-lastrow:yes'>
  ...
  style='font-size:14.0pt;font-family:"TH SarabunPSK"'><?=$agen_full.$agen_name ;?></span></b></p>
  </td>
 </tr>
</table>
<p class=MsoNormal><span style='font-size:1.0pt;font-family:"TH SarabunPSK"'>&nbsp;</span></p>
...
<p class=MsoNormal align=center style='text-align:center'><span
style='font-size:8.0pt;font-family:"TH SarabunPSK"'>&nbsp;</span></p>
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
 style='border-collapse:collapse;mso-yfti-tbllook:480;mso-padding-alt:0cm 5.4pt 0cm 5.4pt'>
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes'>
