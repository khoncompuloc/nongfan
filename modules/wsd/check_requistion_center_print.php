...
require_once("../../setconf.php");
                    $src_number = $_GET['src_number'] ;
	                $db->connectdb(DB_NAME,DB_USERNAME,DB_PASSWORD);
					$res['stock_requistion_center'] = $db->select_query("SELECT * ,UNIX_TIMESTAMP(src_date) AS srcdate FROM ".TB_STOCK_REQUISTION_CENTER." WHERE  src_number=$src_number ");
					...
					$arr['admin_head'] = $db->fetch($res['admin_head']);
				     ...
				     $count_str=mb_strlen($arr['stock_type']['type_name']);
				     if($count_str > 20){
					  $arr_p['type_name']= mb_substr($arr['stock_type']['type_name'],0,20,"utf-8")."ฯ"; 
				     }else{
					  $arr_p['type_name']=$arr['stock_type']['type_name'];
				     }					
					...
					if($arr['admin_head']['elect'] == '1') {
                            $res['head_position'] = $db->select_query("SELECT position_alias_name FROM ".TB_MEMBER_POSITION." WHERE position_id='".$arr['admin_head']['position_id_elect']."'");
					        $arr['head_position'] = $db->fetch($res['head_position']);						
							$elect_name = "ปฏิบัติหน้าที่&nbsp;<b>".$arr['head_position']['position_alias_name']."</b>" ;
					} else if($arr['admin_head']['elect'] == '2') {
                            $res['head_position'] = $db->select_query("SELECT position_alias_name FROM ".TB_MEMBER_POSITION." WHERE position_id='".$arr['admin_head']['position_id_elect']."'");
					        $arr['head_position'] = $db->fetch($res['head_position']);						
							$elect_name = "รักษาราชการแทน&nbsp;<b>".$arr['head_position']['position_alias_name']."</b>" ;					
					} else {
					        $elect_name = "" ;
					}					
					
					if($arr['stock_requistion_center']['src_requistion_logic']==2){
...
style='font-size:0.2pt;line-height:1%;font-family:"TH SarabunPSK","sans-serif"'></span></p>
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
 style='border-collapse:collapse;border:none;mso-yfti-tbllook:1184;mso-padding-alt:
 0cm 5.4pt 0cm 5.4pt;mso-border-insideh:none;mso-border-insidev:none'>
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes'>
 ...
 <tr style='mso-yfti-irow:1'>
  ...
  <td width=205 valign=top align=left style='width:153.65pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:normal'>
  <span lang=TH style='font-size:16.0pt;font-family:"TH SarabunPSK","sans-serif"'>
  <b><?php echo $arr_p['type_name'] ;?></b></span></p>
  </td>
 </tr>
...
?>
 <tr style='mso-yfti-irow:2'>
  <td width=64 height=28 valign=top style='width:47.95pt;border:solid windowtext 1.0pt;
  ...
  <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><b><span lang=TH style='font-size:16.0pt;
  font-family:"TH SarabunPSK","sans-serif"'><?php echo $arr['stock_center']['sc_amount'];?></span></b></p>
  </td>
  <td width=76 valign=top  style='width:2.0cm;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  ...
  <td width=149 valign=middle  style='width:111.7pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
 ...
 0cm 5.4pt 0cm 5.4pt;mso-border-insideh:none;mso-border-insidev:none'>
  ...
  <td width=17 height=5 valign=top style='width:12.5pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><span style='font-size:16.0pt;
  font-family:"TH SarabunPSK","sans-serif"'></span></p>
  </td>
 ...
 <tr style='mso-yfti-irow:5'>
  ...
  <p class=MsoNormal align=center  style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><span lang=TH style='font-size:16.0pt;
  font-family:"TH SarabunPSK","sans-serif"'>ลงชื่อ..........................................................ผู้อนุมัติ</span></p>
  </td>
  <td width=57 valign=top style='width:42.55pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><span style='font-size:16.0pt;
 ...
 <tr style='mso-yfti-irow:9'>
  <td width=17 height=10 valign=top style='width:12.5pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><span style='font-size:16.0pt;
  font-family:"TH SarabunPSK","sans-serif"'></span></p>
  </td>
 ...
 <tr style='mso-yfti-irow:15;mso-yfti-lastrow:yes;height:11pt'>
  <td width=17  height=40 valign=top style='width:12.5pt;padding:0cm 5.4pt 0cm 5.4pt;
  height:11pt'>
  <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:center;line-height:normal'><span style='font-size:16.0pt;
  font-family:"TH SarabunPSK","sans-serif"'></span></p>
