	...
	<TABLE cellSpacing="0" cellPadding="0" width="950" border="0">
      <TBODY>
        <TR>
		  ...
		  &nbsp;&nbsp;<IMG SRC="images/admin/texmenu_stock_start.gif" BORDER="0">->&nbsp;ตัดยอดยกมา ส่วน/กอง<BR>
...
<table width="100%" border="0" cellspacing="1" cellpadding="2">
    <tr>
      <td width="40%">
<form NAME="search_name" METHOD="post" ACTION="?compu=wsd&loc=balance_section&op=search_name" onSubmit="return check_name()" ENCTYPE="multipart/form-data" >
...
?>
	...
	<input type="submit" name="submit" id="submit" value="ค้นหาตามชื่อ" />
      ...
      <td width="60%">
<form NAME="search_type" METHOD="post" ACTION="?compu=wsd&loc=balance_section&op=search_type" onSubmit="return check_type()" ENCTYPE="multipart/form-data" >
...
<?php
    echo "<br><a href=\"?compu=wsd&loc=balance_section&op=new_material&data=voi\" ><img src=\"images/wsd/add_new_material.png\" alt=\"เพิ่มวัสดุตัวใหม่\" align=\"middle\" border=\"0\" width=\"176\" height=\"23\" /></a><br><br>" ; 
...
<?php
        ...
        $arr['sectionName'] = $db->fetch($res['sectionName']);		
		    ...
		    $check_ss_name=mysql_query("select ss_name  FROM ".TB_STOCK_SECTION." WHERE shs_id='".$arr['Check_section']['shs_id']."'ORDER BY ss_id  DESC");
	        list($ss_name)=mysql_fetch_row($check_ss_name);
			empty($ss_name)?$ss_name="":$ss_name=$ss_name ;
				 
		if($ss_name=="ยอดยกมา") {
		$Check_section .= "<p>&nbsp;<input type=\"button\" onClick=\"window.location='?compu=wsd&loc=balance_section&op=addold_material&data=".$arr['Check_section']['shs_id']."';\" value=\"Add..\">";
		} else {
		$Check_section .= "<p>&nbsp;<input type=\"button\" value=\"..No..\">";	
		}
...
?>	 
	 <A HREF="?compu=wsd&loc=balance_section&op=old_material&data=<?php echo $arr['stock_head']['sh_id'];?>">
...
//	echo "<BR>";
//	echo $ShowPages ;
    echo "<br><br><a href=\"?compu=wsd&loc=balance_section&op=new_material&data=voi\" ><img src=\"images/wsd/add_new_material.png\" alt=\"เพิ่มวัสดุตัวใหม่\" align=\"middle\" border=\"0\" width=\"176\" height=\"23\" /></a>" ; 
}
	...
	//$db->closedb ();
		if($rows['stock_head']){
  		 ...
  		 if($check_psd) {	
			...
			$ProcessOutput .= "<BR><BR>";
            echo "<script type='text/javascript'>window.location.href = \"index.php?compu=wsd&loc=balance_section&op=addold_material&data=".$shs_id."\";</script>" ;
		    } else {
...
<form NAME="frmMain" METHOD="post" ACTION="?compu=wsd&loc=balance_section&op=old_material&action=add&data=voi" onSubmit="return check();" ENCTYPE="multipart/form-data">
...
<form NAME="frmMain" METHOD="post" ACTION="?compu=wsd&loc=balance_section&op=new_material&action=add&data=voi" onSubmit="return check();" ENCTYPE="multipart/form-data">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
<td>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
...
<?php	
			...
			//$db->closedb ();
            echo "<script type='text/javascript'>window.location.href = \"index.php?compu=wsd&loc=balance_section&op=addold_material&data=".$_POST['shs_id']."\";</script>" ;
            break;
//***/
...
<form name="frmMain_body" id="frmMain_body" method="post" action="?compu=wsd&loc=balance_section&op=addold_material&action=add&data=voi" onSubmit="return check_body()" enctype="multipart/form-data">  
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr>
<td>
<table width="100%" border="0" cellspacing="0" cellpadding="0">
