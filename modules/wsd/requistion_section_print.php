...
if(!$ProcessOutput AND $op == "requistion_print_add" AND $data != ""){
            $db->connectdb(DB_NAME,DB_USERNAME,DB_PASSWORD); 
				...
				"srs_requistion_logic"=>"".$srs_requistion.""
...
<?php					
					...
					$res['member'] = $db->select_query("SELECT prefix ,fname ,lname ,position_id ,degree_id FROM ".TB_MEMBER." WHERE member_id='".$arr['stock_requistion_section']['member_id']."'");
                    ...
                    $res['stock_section_count'] = $db->select_query("SELECT COUNT(ss_id) AS number FROM ".TB_STOCK_SECTION." WHERE section_id=$section_id AND srs_number='".$arr['stock_requistion_section']['srs_number']."'");
					$arr['stock_section_count'] = $db->fetch($res['stock_section_count']);
                    $res['admin'] = $db->select_query("SELECT member_id FROM ".TB_ADMIN." WHERE level='3' ");
					$arr['admin'] = $db->fetch($res['admin']);
                    $res['passadu'] = $db->select_query("SELECT prefix ,fname ,lname ,position_id FROM ".TB_MEMBER." WHERE member_id='".$arr['admin']['member_id']."' ");
					...
					if($arr['stock_requistion_section']['srs_requistion_logic']==2){
...
function  print_open(srs_number,section_id)
   {
	 //alert(src_number) ;  
     window.open('modules/wsd/check_requistion_section_print.php?srs_number='+srs_number+'&section_id='+section_id+'','','toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=yes,width=10,height=20,left=200,top=50');
   }  
</script> 
<div class=Section1 align="center">
<?php if($check_requistion) { ?>
<p>
<input type="button" name="submit1" id="submit1" onClick="print_open(<?php echo $arr['stock_requistion_section']['srs_number'] ;?>,<?php echo $section_id ; ?>);" value=" พิมพ์ใบเบิก ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" name="submit2" id="submit2" value=" พิมพ์ใบเบิกเรียบร้อยแล้ว " onclick="window.location.href='?compu=wsd&loc=requistion_section_print&op=requistion_print_add&data=<?php echo $arr['stock_requistion_section']['srs_number']; ?>'">
</p>
<?php } ?>
				<TABLE width="940" align="center" cellSpacing="0" cellPadding="0" border="0" >
				<TR>
...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:1;height:17.4pt'>
  ...
  <b><?php echo $arr['stock_requistion_section']['srs_number']." ";?></b>/<b>25<?php echo WEB_BUDGET ;?></b></span></p>
  </td>
 ...
 <tr style='mso-yfti-irow:3;mso-yfti-lastrow:yes'>
  ...
  <p class=MsoNormal align=right style='margin-bottom:0cm;margin-bottom:.0001pt;
  text-align:right;line-height:normal'><span lang=TH style='font-size:16.0pt;
  font-family:"TH SarabunPSK","sans-serif"'>หน่วยงาน&nbsp;&nbsp;<b><?php echo $arr['member_section']['section_name']; ?></b></span></p>
  </td>
 </tr>
</table>
...
<td width=366 valign=top  style='width:274.75pt;padding:0cm 5.4pt 0cm 5.4pt'>
  ...
  <span lang=TH style='font-size:16.0pt;font-family:"TH SarabunPSK","sans-serif"'>วันที่ <b><?php echo "&nbsp;&nbsp;&nbsp;".ThaiTimeConvert($arr['stock_requistion_section']['srsdate'],"3","") ;?></b></span></p>
  </td>
 </tr>
</table>
...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:2;mso-yfti-lastrow:yes'>
  ...
  <span style='font-size:16.0pt;font-family:"TH SarabunPSK","sans-serif"'><b><?php echo $arr['stock_section_count']['number'] ;?></b></span></p>
  </td>
  ...
  <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span lang=TH style='font-size:16.0pt;font-family:"TH SarabunPSK","sans-serif"'>เพื่อดำเนินการใช้ในการปฏิบัติงาน<span
  style='mso-spacerun:yes'>&nbsp;</span>ดังนี้</span></p>
  </td>
 </tr>
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes'>
  ...
  <span lang=TH  style='font-size:10.0pt;font-family:"TH SarabunPSK","sans-serif"'>(shs)</span>
  <span lang=TH  style='font-size:16.0pt;font-family:"TH SarabunPSK","sans-serif"'>รายการ</span></p>
  </td>
...
<?php
                       $count_no = 1 ;
					   $res['stock_secter'] = $db->select_query("SELECT shs_id ,ss_name ,ss_amount ,ss_price ,ss_requistion FROM ".TB_STOCK_SECTION." WHERE section_id=$section_id AND srs_number='".$arr['stock_requistion_section']['srs_number']."' ORDER BY shs_id");
					   while($arr['stock_secter'] = $db->fetch($res['stock_secter'])){
					   $res['stock_head_center'] = $db->select_query("SELECT shs_id ,sh_id FROM ".TB_STOCK_HEAD_SECTION." WHERE shs_id='".$arr['stock_secter']['shs_id']."'");
					   $arr['stock_head_center'] = $db->fetch($res['stock_head_center']);
					   $res['stock_head'] = $db->select_query("SELECT sh_name ,sh_unit FROM ".TB_STOCK_HEAD." WHERE sh_id='".$arr['stock_head_center']['sh_id']."'");
...
?>
 <tr style='mso-yfti-irow:2'>
  ...
  <p class=MsoNormal style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><b>
  <span lang=TH style='font-size:10.0pt;font-family:"TH SarabunPSK","sans-serif"'><?php echo "(".$arr['stock_head_center']['shs_id'].") " ;?></span> 
  <span lang=TH style='font-size:16.0pt;font-family:"TH SarabunPSK","sans-serif"'><b><?php echo $arr['stock_head']['sh_name'] ;?></b></span></p>
  </td>
  <td width=76 valign=top  style='width:2.0cm;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  ...
  <?php echo $arr['stock_secter']['ss_amount'] ;?></span></b></p>
  </td>
  <td width=76 valign=top  style='width:2.0cm;border-top:none;border-left:none;
  border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:2'>
  ...
  <td width=302 valign=top style='width:8.0cm;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal  style='margin-bottom:0cm;margin-bottom:.0001pt;line-height:
  normal'><span lang=TH style='font-size:16.0pt;font-family:"TH SarabunPSK","sans-serif"'>ตำแหน่ง&nbsp;&nbsp;&nbsp;
  <b><?php echo $arr['member_position']['position_name'].$arr['degree']['degree_name'] ;?></b></span></p>
  </td>
  <td width=26 valign=top style='width:19.55pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal align=center style='margin-bottom:0cm;margin-bottom:.0001pt;
