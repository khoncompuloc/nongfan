...
<?php
		...
		$Check_section .= "<p><input type='text' value=' ".$arr['sectionName']['section_id'].". ".$arr_p['name']."' size='15'>";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td height="30" align="center">ประเภท :<?php //echo $arr['stock_head']['type_id']; ?><br>
		<span id="stock_type">
			<SELECT NAME="type_id" ID="type_id" style="color:#006699;font-weight:bold" onChange="dochange('stock_subtype',this.value);" disabled>
<?php
...
?>
  ...
  <tr>
	...
	<input type="text" size="28" maxlength="50" style="color:#006699;font-weight:bold" value="<?php echo $arr['stock_head']['sh_name'];?>" disabled>
	</td>
    <td align="center" colspan="2"><FONT COLOR="#006699"><B>*</B></FONT>ขนาดหรือลักษณะ : <br><input type="text" size="27" style="color:#006699;font-weight:bold" value="<?php echo $arr['stock_head']['sh_diff_name'] ;?>" disabled></td>  
    <td align="center" colspan="2">หน่วยนับ :<br>
			<SELECT NAME="sh_unit" ID="sh_unit" style="color:#006699;font-weight:bold" disabled>
...
<table id="tbExp" width="100%" border="0" cellspacing="2" cellpadding="1" align="center">
  ...
  <tr>
    <td align="center" ><input name="tCalendar_1" type="text" id="tCalendar_1" size="11" value="" disabled>&nbsp;<IMG SRC="images/dateselect.gif" BORDER="0" ALT="เลือกวันที่" onClick="showCalendar(this,1)" align="absmiddle">
	...
	<font id="disp_diff_name_1"><input type="text" name="shp_diff_name_1" id="shp_diff_name_1" size="27" value="">
	</font>
	<!-- <input  type="button" onClick="#" value=".N." disabled> --><br><br>
...
<FONT COLOR="#006699" ALIGN="left"><B>*</B>&nbsp;ถ้ามีการกำหนดให้แต่ต่างจาก 4 ฟิวด์นี้&nbsp;ให้เพิ่มรายการเป็นวัสดุตัวใหม่</FONT><br>
<FONT COLOR="#ff0000" ALIGN="left"><B>*</B>&nbsp;ถ้าต้องการให้ใช้ชื่อบัญชีวัสดุตัวเดียวแต่มี หลายขนาดหรือลักษณะ&nbsp;ให้กำหนดในช่องตามเครื่องหมาย * </FONT>
...
***/
if(document.frmMain.sh_date_1.value=="") {
alert("กรุณากรอก วันที่  ด้วยครับ") ;
document.frmMain.tCalendar_1.focus() ;
return false ;
}
if(document.frmMain.sc_name_1.value=="") {
alert("กรุณากรอก   รับจาก   ด้วยครับ") ;
document.frmMain.sc_name_1.focus() ;
return false ;
}
if(document.frmMain.sc_ref_1.value=="") {
alert("กรุณากรอก   เลขที่เอกสาร   ด้วยครับ") ;
document.frmMain.sc_ref_1.focus() ;
return false ;
}
...
<?php	
	...
	$res['stock_head'] = $db->select_query("SELECT sh_id FROM ".TB_STOCK_HEAD." WHERE type_id='".$_POST['type_id']."' AND sh_name='".$_POST['sh_name']."' AND sh_diff_name='".$sh_diff_name."' AND sh_unit='".$sh_unit."'");
	$rows['stock_head'] = $db->rows($res['stock_head']); 
	//$db->closedb ();
		if($rows['stock_head']){
		    echo "<script language='javascript'>" ;
...
//	 var sh_diff_name = document.frmMain.sh_diff_name.value ; 
      //alert(sh_id);	 
//     window.open('modules/wsd/sh_diff_name_add.php?line='+line+'&sh_diff_name='+sh_diff_name+'','','toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=yes,width=450,height=200,left=330,top=200');
//   } 
function chkNum(ele)
{
var num = parseFloat(ele.value);
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr><td colspan="6" height="10"></td></tr>
  <tr>
	<td  height="30" align="center" colspan="2">ชื่อหรือชนิดวัสดุ :<br><input type="text" name="sh_name" id="sh_name" size="35" maxlength="50"></td>
    <td align="center">ขนาดหรือลักษณะ : <br><input type="text" size="27" name="sh_diff_name" id="sh_diff_name" value=""></td>  
    <td align="center" colspan="2">หน่วยนับ :<br>
...
<table id="tbExp" width="100%" border="0" cellspacing="2" cellpadding="1" align="center">
  ...
  <tr>
    <td align="center" ><input type="text" name="tCalendar_1" id="tCalendar_1" size="11" value="" disabled>&nbsp;<IMG SRC="images/dateselect.gif" BORDER="0" ALT="เลือกวันที่" onClick="showCalendar(this,1)" align="absmiddle">
	<br><input type="hidden" name="sh_date_1" id="sh_date_1" size="12" value=""></td>
    <td align="left">
	<select name="sc_logic_1" id="sc_logic_1" >
<!--	<option value="0" >จ่ายให้</option>  -->
    ...
    <td align="center"><FONT COLOR="#ff0000"><B>*</B></FONT>
	<input type="text" name="shp_diff_name_1" id="shp_diff_name_1" size="27" value="">
	<!-- <input  type="button" onClick="diff_name_open(1)" value=".N." disabled> --><br><br>
	 เลขที่เอกสาร :<input type="text" name="sc_ref_1" id="sc_ref_1" size="15" value="" >
	</td>
    <td align="center">
	จำนวน&nbsp;:<input type="text" name="sc_amount_1" id="sc_amount_1" size="9" style="text-align:center;" value="">
...
<FONT COLOR="#ff0000" ALIGN="left"><B>*</B>&nbsp;ถ้าต้องการให้ใช้ชื่อวบัญชีัสดุตัวเดียวแต่มีหลายขนาดหรือลักษณะ&nbsp;ให้กำหนดในช่องตามเครื่องหมาย * </FONT>
...
<?php	
			...
			//$pricecost = $pricecost + ($_POST['sc_price_1']*$_POST['sc_amount_1']);
			    ...
			    $check_sc_id=mysql_query("SELECT sc_amountcost  FROM ".TB_STOCK_CENTER." WHERE shc_id='".$_POST['shc_id']."' ORDER BY sc_id  DESC");
...
<tr>
    ...
    <td height="30" align="center">ประเภท :<br>
						<span id="stock_type">
						<SELECT NAME="type_id" ID="type_id" style="color:#006699;font-weight:bold" disabled>
						<?php
						$res['stock_type'] = $db->select_query("SELECT * FROM ".TB_STOCK_TYPE." ORDER BY type_id");
						while($arr['stock_type'] = $db->fetch($res['stock_type'])) {
						?>
    ...
    <td align="center">ที่เก็บ :<br><input type="text" name="shc_keep" id="shc_keep" size="23" value="<?php echo $arr['stock_head_center']['shc_keep'] ;?>" disabled></td>	
</tr>
<tr><td colspan="6" height="10"></td></tr>
<tr>
	<td  height="30" align="center" colspan="2">ชื่อหรือชนิดวัสดุ :<br><input type="text" size="28" style="color:#006699;font-weight:bold" value="<?php echo $arr['stock_head']['sh_name'] ;?>" disabled></td>
    <td align="center"><FONT COLOR="#006699"><B>*</B></FONT>ขนาดหรือลักษณะ : <br><input type="text" size="27" style="color:#006699;font-weight:bold" value="<?php echo $arr['stock_head']['sh_diff_name'] ;?>" disabled></td>  
    <td align="center" colspan="2">หน่วยนับ :<br>
	
						<SELECT NAME="sh_unit" ID="sh_unit" onChange="dochange_unit();" style="color:#006699;font-weight:bold" disabled>
						<?php
						$res['stock_unit'] = $db->select_query("SELECT * FROM ".TB_STOCK_UNIT." ORDER BY unit_id");
						while($arr['stock_unit'] = $db->fetch($res['stock_unit'])) {
						?>
    ...
    <td height="30" align="center">จำนวนอย่าง :<br>สูง <input type="text" name="shc_high" id="shc_high" size="6" maxlength="6" value="<?php echo $arr['stock_head_center']['shc_high'] ;?>" style="text-align:center;" disabled>&nbsp;&nbsp;ต่ำ 
    <input type="text" name="shc_low" id="shc_low" size="6" maxlength="6" value="<?php echo $arr['stock_head_center']['shc_low'] ;?>" style="text-align:center;" disabled></td>	
  </tr>
</table>
<br>
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
...
alert("กรุณาใส่  รับจาก  ด้วยครับ") ;
document.frmMain_body.sc_name_1.focus() ;
return false ;
}
if(document.frmMain_body.sc_ref_1.value=="") {
alert("กรุณาใส่  เลขที่เอกสาร  ด้วยครับ") ;
document.frmMain_body.sc_ref_1.focus() ;
return false ;
}
if(document.frmMain_body.sc_price_1.value=="") {
alert("กรุณาใส่  ราคาต่อหน่วย  ด้วยครับ") ;
document.frmMain_body.sc_price_1.focus() ;
return false ;
}
