...
$count = 16 ; //จำนวนแถว
	...
	$res['stock_section'] = $db->select_query("SELECT UNIX_TIMESTAMP(ss_date) AS ss_date ,ss_name ,ss_ref ,ss_price ,ss_amount ,ss_amountcost ,ss_pricecost ,ss_note ,ss_logic ,ss_requistion ,srs_number ,shp_id FROM ".TB_STOCK_SECTION." WHERE shs_id='".$shs_id."' ORDER BY ss_id ");
...
<table class=MsoTableGrid border=0 cellspacing=0 cellpadding=0
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
  ...
  แผ่นที่&nbsp;&nbsp;<b><?php echo $i ;?></b>&nbsp;&nbsp;(&nbsp;<?php echo $arr['stock_head']['sh_code_id'] ;?>&nbsp;)&nbsp;วัสดุที่<?php echo " ".$arr['stock_head_section']['acc_number'] ;?></span></p>
  </td>
  <td width=502 valign=top style='width:376.75pt;padding:0cm 5.4pt 0cm 5.4pt'>
